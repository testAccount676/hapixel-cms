  ...
  return (
    <div className="mt-4 flex flex-wrap items-center justify-center gap-2 px-10 sm:justify-between">
      <div>
        {hasData ? (
          <>
            <div className="rounded-md border border-blue-400 bg-blue-200 p-2 text-center text-sm text-blue-400">
              <p>
                Página {pagination.from} - {pagination.to} de {pagination.total}
              </p>
            </div>
          </>
        ) : (
